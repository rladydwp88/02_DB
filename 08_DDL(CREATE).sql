...
-- DEFAULT 설정된 컬럼이라고 삽입/수정 시 DEFAULT만 작성 해야하는 것 아님!
...
INSERT INTO "MEMBER2"
VALUES('MEM01', 'PASSEMP_01', '고길동', 01012341234);
...
--  0으로 시작 될 가능성이 있으면 CHAR, VARCHAR2같은 문자열 타입으로 사용
...
1, 'USER01', 'PASS_01', '홍길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);

INSERT INTO USER_USED_NN VALUES (
NULL, 'USER01', 'PASS_01', '홍길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);

-- 01400: NULL을 ("KH"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_UK2 VALUES (
1, 'USER02', 'PASS_01', '홍길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);

INSERT INTO USER_USED_UK2 VALUES (
1, 'USER01', 'PASS_01', '고길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);
...
2, 'USER01', 'PASS_01', '홀길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);

INSERT INTO USER_USED_PK2 VALUES (
2, 'USER02', 'PASS_01', '홀길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);

INSERT INTO USER_USED_PK2 VALUES (
1, 'USER02', 'PASS_01', '홀길동', '남자',
'010-1234-5678', 'hong_gd@or.kr'
);
...
CREATE TABLE USER_USED_FK (
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRAD_CODE_FK
	REFERENCES USER_GRADE /*(GRADE_CODE)*/ -- 컬럼레벨
												-- 컬럼명 미작성 시 USER_GRADE 테이블의 PK를 자동 참조함.
	-- 테이블 레벨 
	--, CONTRAINT GRADE_CODE_FK FOREIGN KEY(GRADE_CODE)	
...
--> ORA-02291: 무결성 제약조건(KH.GRAD_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02292: 무결성 제약조건(KH.GRAD_CODE_FK)이 위배되었습니다
-- 자식 레코드가 발견되었습니다
...
CREATE TABLE USER_USED_FK2 (
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRAD_CODE_FK2
...
CREATE TABLE USER_USED_FK3 (
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRAD_CODE_FK3
...
-- 부모, 부모를 참조하던 자식 까지 삭제가 되어
-- 오류 없이 수행.
DELETE FROM USER_GRADE3
WHERE GRADE_CODE = 10;

SELECT * FROM USER_GRADE3; -- 부모에서 10 삭제됨
SELECT * FROM USER_USED_FK3; -- 부모의 10을 참고하고 있던 자식 행 삭제됨
...
INSERT INTO USER_USED_CHECK VALUES (
1, 'USER01', 'PASS01', '홀길동', '남',
'010-1234-5678', 'hong_gd@or.kr여'
);
