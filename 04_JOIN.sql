...
-- 마케팅부, 국내여업부, 해외영업3부와 매칭되는 사원이 EMPLOYEE 테이블에 없음
...
--> JOIN 구문 잘못 작성하는 경우 CROSS JOIN의 결과를 조회됨
...
SELECT EMP_NAME 사원명, JOB_NAME 직급명, SALARY 급여, SUM(SALARY*12) 연봉
FROM EMPLOYEE
JOIN JOB USING(JOB_CODE)
