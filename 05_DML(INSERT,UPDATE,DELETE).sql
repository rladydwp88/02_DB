...
-- 주의 : 혼자서 COMMIT, ROLLBACK 수 행하지 말 것 !
-- 윈도우 > 설정 > 연결 > 연결유형
...
-- 1) INSERT INTO 테이블명 VALUES(테이터, 데이터, 데이터..)
...
INSERT INTO EMPLOYEE2 (EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE, DEPT_CODE,
 ...
 VALUES ('900', '홍길동', '991215-124567', 'hong_gd@or.kr', '01011111111',
'D1', 'J7', 'S3', 4300000);
...
-- 서브쿼리(SELECT) 결과물 EMP_01 테이블에 INSERT
...
SELECT * FROM EMPLOYEE2
WHERE EMPLOYEE2.EMP_NAME E = '홍길동';
