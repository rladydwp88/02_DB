...
-- 더미테이블? 실제 테이터를 저장하는게 아닌, 임시 계산이나 테스트 목적 사용.
...
-- 4. ORDER BY 절 : ORDER BY 컬러명 | 별칭 | 컬럼 순서 | [ASC | DESC] | [NULLS FIRST | LAST]

-- EMPLOYEE 테이블에서 
-- 급여가 3백만원 초과인 사원의
-- 사번, 이름, 급여, 부서 코드를 조회해라.
